 ...
 */
    ...
    useEffect(() => {
      axios
        .get("https://caauri-api.cyclic.cloud/courses_details/absec/656806637ed0d3bd7761ba35")
        .then((res) => {
             setP1(res.data.p1)
             setP2(res.data.p2)
        })
    ...
    const handleSubmit = (e) => {
      ...
      axios
        .put(
          "https://caauri-api.cyclic.cloud/courses_details/absec/656806637ed0d3bd7761ba35",
          data
        )
            ...
            </li>
     {
      ...
      <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
        ...
        <div className="w-full h-[100vh] rounded border-dashed border-2 border-gray-300">
          <iframe
            src="https://absec.netlify.app/course-detail"
