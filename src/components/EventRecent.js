...
function EventRecent() {
  ...
  const handleSubmit = async (e) => {
    ...
    axios
      .post("https://caauri-api.cyclic.cloud/event_recent/absec", formData)
      .then((res) => {
  ...
  const [allData, setAllData] = useState([
    { title: "", theme: '', place : '' , hours : '' , by : '' },
  ]);

  useEffect(() => {
    axios
      .get("https://caauri-api.cyclic.cloud/event_recent/absec")
      .then((res) => {
        setAllData(res.data);
      })
            ...
            </li>
     {
      ...
      <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
            ...
            >
              <form
                ...
                onSubmit={(e) => {
                  ...
                  axios
                    .put(
                      `https://caauri-api.cyclic.cloud/event_recent/absec/${data._id}`,
                      updatedData
                    )
              ...
              >
                ...
                <img
                  src={data.imageUrl}
                  className="h-[300px] object-cover ml-auto mr-auto  w-[300px] "
                />
        ...
        <div className="w-full h-[100vh] rounded border-dashed border-2 border-gray-300">
          <iframe
             src="https://absec.netlify.app/portfolio"
