...
function FuturEvent() {
  ...
  const handleSubmit = async (e) => {
    ...
    axios
      .post("https://caauri-api.cyclic.cloud/futur_event/absec", formData)
      .then((res) => {
  ...
  const [allData, setAllData] = useState([
    { title: "", theme: '', place : '' , date : '' , by : '' , category : '' , synopsis : '' , theme1 : '' , theme2 : '' , theme3 : ''},
  ]);

  useEffect(() => {
    axios
      .get("https://caauri-api.cyclic.cloud/futur_event/absec")
      .then((res) => {
        setAllData(res.data);
      })
  ...
  return (
    <div className="flex flex-no-wrap">
      ...
      <div className="w-64 absolute sm:relative bg-[#07983d] shadow h-[1000vh] flex-col justify-between hidden sm:flex">
        <div className="px-8 py-8">
          <div className="h-16 w-full flex items-center">
            <img src="/images/logo.jpeg" alt="" />
          </div>
          <ul className="mt-20">
            <li className="flex w-full justify-between text-white hover:text-gray-500 cursor-pointer items-center mb-8">
              <Link to="/">
            ...
            <li className="flex w-full justify-between text-white hover:text-gray-500 cursor-pointer items-center mb-8">
              <Link to="/faq">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Faq's</span>
                </div>
              </Link>
            </li>
            <li className="flex w-full justify-between text-[#fff] hover:text-gray-500 cursor-pointer items-center mb-8">
              <Link to="/courses">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="text-sm  ml-2">Courses Details</span>
                </div>
              </Link>
            </li>
            <li className="flex w-full justify-between text-[#fff] hover:text-gray-500 cursor-pointer items-center mb-8">
            ...
            <li className="flex w-full justify-between text-[#fff] hover:text-gray-500 cursor-pointer items-center mb-8">
              <Link to="/event_recent">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Recent Event</span>
                </div>
              </Link>
            </li>
            <li className="flex w-full justify-between text-[#f6783a] hover:text-gray-500 cursor-pointer items-center mb-8">
              <Link to="/event_futur">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="text-sm  ml-2">Futur Event</span>
                </div>
              </Link>
            </li>
     {
      ...
      <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
          ...
          <form className="flex flex-col w-full" onSubmit={handleSubmit}>
            <div className="flex">
              ...
              <strong>Organise par</strong>
                ...
                />
                <strong>trinité de sujets</strong>
              ...
              <strong>thematique</strong>
                ...
                />
                 <strong>image de l'event</strong>
                <Input
            ...
            <div className="w-full py-8 flex items-center justify-center">
              <button
                type="submit"
                className="bg-[#f6783a] p-2 text-white rounded-xl cursor-pointer hover:bg-gray-900 transition-all"
              >
                envoyez
              </button>
            </div>
            ...
            >
              <form
                ...
                onSubmit={(e) => {
                  ...
                  axios
                    .put(
                      `https://caauri-api.cyclic.cloud/futur_event/absec/${data._id}`,
                      updatedData
                    )
              ...
              >
                <div className="flex py-8 space-x-2">
                  <Textarea
                    variant="standard"
                    label="titre"
                    value={data.title}
                  ...
                  <Textarea
                    ...
                    className="border-r border-black"
                    onChange={(e) =>
                      handleChange(index, "synopsis", e.target.value)
                    }
                  />
                </div>
                <div className="flex py-2 space-x-2">
                  <Textarea
                    ...
                    className="border-r border-black"
                    onChange={(e) =>
                      handleChange(index, "theme", e.target.value)
                    }
                  />
                </div>
                <strong>trinité de sujets</strong>
                <div className="w-full flex xl:flex-row flex-col xl:space-y-0 space-x-0 xl:space-x-2  space-y-2 py-2">
                <Input
                  label="1"
                  value={data.theme1}
                  name="theme1"
                  onChange={(e) =>
                      handleChange(index, "theme1", e.target.value)
                    }
                />
                <Input
                  label="2"
                  ...
                  name="theme2"
                  onChange={(e) =>
                      handleChange(index, "theme2", e.target.value)
                    }
                />
                <Input
                  label="3"
                  ...
                  name="theme3"
                  onChange={(e) =>
                      handleChange(index, "theme3", e.target.value)
                    }
                />
                </div>
                <div className="w-full flex xl:flex-row flex-col xl:space-y-0 space-x-0 xl:space-x-2  space-y-2 py-2">
                ...
                <div className="w-full flex xl:flex-row flex-col xl:space-y-0 space-x-0 xl:space-x-2  space-y-2 py-2">
                  <Input
                    ...
                    className="border-r border-black"
                    onChange={(e) =>
                      handleChange(index, "by", e.target.value)
                    }
                  />
                    <Input
                    label="category"
              ...
              <div className="w-full px-2 flex xl:flex-row  flex-col xl:space-x-2 space-x-0 xl:space-y-0 space-y-2">
              <img
                  src={data?.picture?.[0]}
                  className="h-[300px] object-cover xl:ml-auto xl:mr-auto w-full  xl:w-1/3 "
                />
              <img
                  src={data?.picture?.[1]}
                  className="h-[300px] object-cover xl:ml-auto xl:mr-auto w-full xl:w-1/3 "
        ...
        <div className="w-full h-[100vh] rounded border-dashed border-2 border-gray-300">
          <iframe
             src="https://absec.netlify.app/portfolio-detail"
            //src="http://127.0.0.1:5500/avarton-coach-online-courses-template-2023-03-12-04-57-14-utc/avarton-package/avarton/index.html"
