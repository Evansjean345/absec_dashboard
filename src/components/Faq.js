...
function Faq() {
  ...
  useEffect(() => {
    axios
      .get("https://caauri-api.cyclic.cloud/faq/absec/656943302f6a0cc03fac708d")
      .then((res) => {
        setOne(res.data.one)
        setTwo(res.data.two)
        ...
        setSix(res.data.six)
        setSeven(res.data.seven)
        setEight(res.data.eight)
        setNine(res.data.nine)
        setTen(res.data.ten)
      })
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put("https://caauri-api.cyclic.cloud/faq/absec/656943302f6a0cc03fac708d", data)
  ...
  return (
    <div className="flex flex-no-wrap">
      ...
      <div className="w-64 absolute sm:relative bg-[#07983d]  shadow h-[300vh] flex-col justify-between hidden sm:flex">
            ...
            <li className="flex w-full justify-between text-white hover:text-gray-500 cursor-pointer items-center mb-8">
              <Link to="/event_recent">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Event Recent</span>
                </div>
              </Link>
            </li>
            <li className="flex w-full justify-between text-white hover:text-gray-500 cursor-pointer items-center mb-8">
      ...
      <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
        ...
        <div className="w-full flex mb-12 rounded shadow-xl">
          <form className="flex flex-col w-full" onSubmit={handleSubmit}>
            <div className="flex">
              <div className="w-1/2 py-8 px-8">
              <strong>Question et reponse 1</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={one?.title}
                ...
                />
                  <strong>Question et reponse 2</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={two?.title}
              ...
              <Textarea
                ...
                />
                  <strong>Question et reponse 3</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={three?.title}
                ...
                />
               <strong>Question et reponse 4</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={four?.title}
                ...
                />
                <strong>Question et reponse 5</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={five?.title}
              ...
              <div className="w-1/2 py-8 px-8">
              <strong>Question et reponse 6</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={six?.title}
                ...
                />
                <strong>Question et reponse 7</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={seven?.title}
                ...
                />
              <strong>Question et reponse 8</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={eight?.title}
                ...
                />
              <strong>Question et reponse 9</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={nine?.title}
                ...
                />
               <strong>Question et reponse 10</strong>
              <Input
                  variant="standard"
                  label="titre"
                  value={ten?.title}
        ...
        <div className="w-full h-[100vh] rounded border-dashed border-2 border-gray-300">
          <iframe
                       src="https://absec.netlify.app/faq"
